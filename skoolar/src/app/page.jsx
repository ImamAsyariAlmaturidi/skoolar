  ...
  return (
    <div className="min-h-screen bg-white flex flex-col w-full">
      <header className="fixed py-4 px-28 flex justify-between items-center bg-white z-50 w-screen">
        <img className="h-10" src="https://res.cloudinary.com/dqrmcom6v/image/upload/v1725532172/SKOOLAR_trw2yi.png" alt="" />
        <nav className="hidden md:block">
          <ul className="flex space-x-4 text-[#2B478B] text-base">
            <li>
              <ScrollLink to="home" smooth={true} duration={500} className="hover:text-[#1E3A8A] cursor-pointer">
                Home
              </ScrollLink>
            </li>
            <li>
              <ScrollLink to="feature" smooth={true} duration={500} className="hover:text-[#1E3A8A] cursor-pointer">
                Feature
              </ScrollLink>
            </li>
            <li>
              <ScrollLink to="why-us" smooth={true} duration={500} className="hover:text-[#1E3A8A] cursor-pointer">
                Why Us
              </ScrollLink>
            </li>
            <li>
              <ScrollLink to="review" smooth={true} duration={500} className="hover:text-[#1E3A8A] cursor-pointer">
                Reviews
              </ScrollLink>
            </li>
          </ul>
      ...
      <main className="flex-grow bg-white">
        <section id="home" className="container mx-auto py-12 flex items-center px-7">
          <motion.div ref={ref} initial="hidden"
            ...
            <div className="flex space-x-4">
              ...
              <ScrollLink to="why-us" smooth={true} duration={500} className="px-4 py-2 border border-[#0165FF] text-[#0165FF] rounded-md hover:bg-gray-100 flex items-center text-sm md:text-base">
                Find More
                <svg
        ...
        <FadeInSection>
          <div initial="hidden"
            animate="visible"
            variants={fadeIn}
            transition={{ delay: 0.2 }} className="flex flex-col justify-center items-center w-full px-36">
            <p className="text-center font-semibold text-4xl">
              We Serve You With Various <br /> Feature For <span className="underline"> School </span> and <span className="underline">Parent</span>
            </p>
        ...
        <section id="feature" className="w-full h-auto mt-10 flex justify-between ">
          <div className="mt-20">
            ...
            <p className="ml-32 mt-10 pr-16 text-neutral-400">
              Our app provides fast and reliable communication through an integrated platform that features real-time chat for easy conversations between parents, teachers, and students. Additionally, it includes a payment system for handling school-related transactions and an assignment management tool, allowing students to track and submit their work while parents monitor their progress—all within a single, user-friendly application designed to streamline communication and enhance the overall educational experience.
            </p>
          </div>
        ...
        <FadeInSection>
          ...
          <section id="review" className="px-32 mt-12 flex w-full mb-20 bg-blue-50 py-16 bg-opacity-70">
