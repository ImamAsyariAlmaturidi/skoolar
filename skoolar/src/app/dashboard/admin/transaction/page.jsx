...
const TuitionPaymentStatusPage = () => {
    // Dummy data for students and payment status
    const [students, setStudents] = useState([
        { id: 1, name: 'John Doe', nisn: '123456789', group: '6A', hasPaid: true },
        { id: 2, name: 'Jane Smith', nisn: '987654321', group: '4C', hasPaid: false },
        { id: 3, name: 'Alice Johnson', nisn: '456789123', group: '3B', hasPaid: false },
