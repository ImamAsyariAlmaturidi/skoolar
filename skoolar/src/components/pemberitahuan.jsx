export default function Pemberitahuan() {
  return (
    <>
      <section className="flex items-center gap-3 text-black text-[17px] font-medium flex gap-2 px-2 mt-2 mb-4">
        <img
      ...
      <div className="w-full h-[70%] py-3 overflow-auto px-2 bg-white">
        <div className="flex flex-col gap-4">
          <section className="w-full py-4 px-4  shadow-md rounded-2xl">
            <span className="text-black text-[14px]">Keuangan</span>
            <p className="text-neutral-600 truncate text-[12px]">
              Kpd YTH Bpk.Fathan , dengan hormat kami memberitahu bahwa
              pembayaran sudah telat selama 3 bulan...
            </p>
          </section>
          <section className="w-full py-4 px-4  shadow-md  rounded-2xl">
            <span className="text-black text-[14px]">Keuangan</span>
