    ...
    return (
        <>
            ...
            <div className="flex items-center">
                ...
                <p className="text-3xl ml-5 font-semibold text-neutral-800"> Assignment</p>
            </div>
            <div className="flex items-center">
                <svg
                    fill="currentColor"
            ...
            <div className="flex items-center">
                ...
                <p className="text-3xl ml-5 font-semibold text-neutral-800"> Notification</p>
            </div>
            ...
            <div className="flex items-center">
                ...
                <p className="text-3xl ml-5 font-semibold text-neutral-800"> Dashboard</p>
            </div>
            <div className="flex items-center">
                <svg
                    width="64px"
